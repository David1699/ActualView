...
public class SeriesEstrenosFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Aquí se muestran todas las series estrenos
        View view = inflater.inflate(R.layout.fragment_series_estrenos, container, false);
        inicializarFirebase();
