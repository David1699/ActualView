...
public class PeliculasPopularesFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Aquí se muestran todas las peliculas populares
        View view = inflater.inflate(R.layout.fragment_peliculas_populares, container, false);
        inicializarFirebase();
        listView = (ListView) view.findViewById(R.id.listViewMoviesPopulares);
