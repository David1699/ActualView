...
public class PeliculasEstrenosFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Aquí se muestran todas las peliculas estrenos
        View view = inflater.inflate(R.layout.fragment_peliculas_estrenos, container, false);
        inicializarFirebase();
