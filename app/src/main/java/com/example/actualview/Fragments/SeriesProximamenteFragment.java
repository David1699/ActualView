...
public class SeriesProximamenteFragment extends Fragment implements View.OnClickListener {
    ...
    public SeriesProximamenteFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Aquí se muestran todas las series proximamente
        View view = inflater.inflate(R.layout.fragment_series_proximamente, container, false);
        inicializarFirebase();
        series = new ArrayList<Series>();
        listView = (ListView) view.findViewById(R.id.listViewSeriesProximamente);
        databaseReference.child("Series").addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot objSnaptshot : dataSnapshot.getChildren()){
                    ...
                    if(s.getProximamente()!=null) {
                        if (s.getProximamente()) {
