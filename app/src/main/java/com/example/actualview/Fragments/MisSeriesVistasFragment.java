...
public class MisSeriesVistasFragment extends Fragment implements View.OnClickListener{
    ...
    public MisSeriesVistasFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Aquí se muestran todas las series vistas
        View view = inflater.inflate(R.layout.fragment_misseries_vistas, container, false);
        inicializarFirebase();
