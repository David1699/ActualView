...
public class MisPeliculasVistasFragment extends Fragment implements View.OnClickListener{
    ...
    public MisPeliculasVistasFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Aquí se muestran todas las peliculas vistas
        View view = inflater.inflate(R.layout.fragment_mispeliculas_vistas, container, false);
        inicializarFirebase();
