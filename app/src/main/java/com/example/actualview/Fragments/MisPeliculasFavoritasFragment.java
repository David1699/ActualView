...
public class MisPeliculasFavoritasFragment extends Fragment implements View.OnClickListener{
    ...
    public MisPeliculasFavoritasFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Aquí se muestran todas las peliculas favoritas
        View view = inflater.inflate(R.layout.fragment_mispeliculas_favoritas, container, false);
        inicializarFirebase();
